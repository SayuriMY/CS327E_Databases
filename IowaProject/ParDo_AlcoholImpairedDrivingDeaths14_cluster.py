...
options = {
        ...
        'job_name':'transform-alcohol-impaired-driving-deaths14',
        'project': PROJECT_ID,
...
with beam.Pipeline('DataflowRunner', options=opts) as p:
   ...
   qualified_table_name = PROJECT_ID + ':IowaIAlcoholImpairedDrivingDeaths.ParDo_AlcoholImpairedDrivingDeaths14'
